...
Public Function getTopInclude()
	...
	Html = Html & "                            <li><a href=""http://class.baewha.ac.kr/user/smartit/index.action"">스마트IT학과 소개</a>"
	Html = Html & "                                <ul class=""subGnb subGnb01"">"
	Html = Html & "                                    <li><a href=""http://class.baewha.ac.kr/user/smartit/index.action"" target=""_new"">스마트IT학과 소개</a></li>"
	Html = Html & "                                </ul>"
	Html = Html & "                            </li>"
	Html = Html & "                            <li><a href=""/Service/Sub/appl/03_01.asp"">졸업작품전(A반/B반)</a>"
	Html = Html & "                                <ul class=""subGnb subGnb03"">"
	Html = Html & "                                    <li><a href=""/Service/Sub/appl/03_01.asp"">졸업작품전 A반</a></li>"
	Html = Html & "                                    <li><a href=""/Service/Sub/appl/03_02.asp"">졸업작품전 B반</a></li>"
	Html = Html & "                                </ul>"
	Html = Html & "                            </li>"
	Html = Html & "                        </ul>"
	Html = Html & "                    </div>"
	...
	Html = Html & "                                <li><a href=""/Service/Sub/appl/01_01.asp"">스마트IT학과 소개</a></li>"
	Html = Html & "                            </ul>"
	Html = Html & "                        </li>"
	Html = Html & "                        <li><span>졸업작품전(A반/B반)</span>"
	Html = Html & "                            <ul class=""submenu"">"
	Html = Html & "                                <li><a href=""/Service/Sub/appl/03_01.asp"">졸업작품전 A반</a></li>"
	Html = Html & "                                <li><a href=""/Service/Sub/appl/03_02.asp"">졸업작품전 B반</a></li>"
	Html = Html & "                            </ul>"
